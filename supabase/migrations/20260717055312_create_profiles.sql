...
$function$;
CREATE TABLE public.profiles (id uuid NOT NULL, username text, full_name text, avatar_url text, website text, banned_at timestamp with time zone, updated_at timestamp with time zone);
